...
> 免费、全程本地、不上传任何内容,产出直接进**你惯用的剪辑软件**——开箱时会问你用哪款:
> 剪映/CapCut 给原生分轨草稿(支持最深),Resolve/Premiere/FCP 走 EDL/OTIO,其余给万能素材包。
...
| **工程直出你的剪辑器** | ✅ 独门 | 开箱问你用哪款;剪映/CapCut 原生草稿最深,EDL/OTIO/素材包兜底 |
...
9. **质检**——机器查五项(黑帧/爆音/字幕空洞/静默区死寂/响度),一项不过不交付;
   ...
   条件句的另一半有没有着落)。
10. **交付**——预览 mp4+你那款剪辑器的工程双件套,报路径为止;**发到哪里,问了你才动**(硬停点3)。
